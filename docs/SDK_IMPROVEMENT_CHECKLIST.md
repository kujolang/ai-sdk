...
- Commands run: kujo test-run tests/sdk_contract_tests.kujo (failed: unrecognized subcommand under the Python linter); kujo test-run tests/sdk_contract_tests.kujo (pass); kujo run main.kujo --interpreter (pass); kujo run stress_harness.kujo --interpreter (pass).
- README updated: Yes
...
- Commands run: kujo test-run tests/sdk_contract_tests.kujo (pass); kujo run main.kujo --interpreter (pass).
- README updated: Yes
...
- Commands run: kujo test-run tests/sdk_contract_tests.kujo (pass after nested dict assignment fix); kujo run main.kujo --interpreter (pass).
- README updated: Yes
...
- Commands run: kujo test-run tests/sdk_contract_tests.kujo (pass).
- README updated: No
...
- Commands run: kujo test-run tests/sdk_contract_tests.kujo (pass); kujo run examples/main.kujo --interpreter (pass); kujo run scripts/stress_harness.kujo --interpreter (pass); README stale-path grep check (no stale matches).
- README updated: Yes
...
- Commands run: kujo test-run tests/sdk_contract_tests.kujo (pass); kujo run examples/main.kujo --interpreter (pass); README path grep for stale commands (no stale matches).
- README updated: Yes
...
- Commands run: kujo test-run tests/sdk_contract_tests.kujo (pass); kujo run examples/main.kujo --interpreter (pass); README command path grep (pass).
- README updated: Yes
...
- Commands run: kujo test-run tests/sdk_contract_tests.kujo (pass); kujo run examples/main.kujo --interpreter (pass).
- README updated: Yes
...
- Commands run: rm -f test_assign.kujo test_closure.kujo test_closure_simple.kujo test_final.kujo test_read.kujo test_simple_f.kujo test_top_level.kujo; git ls-files --others --exclude-standard (pass/no output); kujo test-run tests/sdk_contract_tests.kujo (pass).
- README updated: No
...
- Commands run: kujo test-run tests/sdk_contract_tests.kujo (pass); kujo test-run tests/live_provider_smoke_tests.kujo (pass).
- README updated: Yes
...
- Commands run: kujo test-run tests/reliability_failure_modes_tests.kujo (pass); kujo test-run tests/sdk_contract_tests.kujo (pass); kujo test-run tests/live_provider_smoke_tests.kujo (pass).
- README updated: Yes
...
- Commands run: kujo test-run tests/parser_fuzz_smoke_tests.kujo (pass); kujo test-run tests/feature_smoke_tests.kujo (pass); KUJO_BIN=kujo bash scripts/release_quality_gates.sh (pass, aggregate tests: 49).
- README updated: Yes
...
- Commands run: bash scripts/supply_chain_policy_check.sh (pass); bash scripts/generate_integrity_manifest.sh artifacts/security (pass); KUJO_BIN=kujo bash scripts/release_quality_gates.sh (pass).
- README updated: Yes
...
- Commands run: kujo test-run tests/sdk_contract_tests.kujo (pass); KUJO_BIN=kujo bash scripts/release_quality_gates.sh (pass).
- README updated: Yes
...
- Commands run: kujo test-run tests/sdk_contract_tests.kujo (pass); KUJO_BIN=kujo bash scripts/release_quality_gates.sh (pass, aggregate tests: 54).
- README updated: Yes
...
- Commands run: kujo run examples/telemetry_bridge.kujo --interpreter (pass); KUJO_BIN=kujo bash scripts/release_quality_gates.sh (pass).
- README updated: Yes
...
- Commands run: kujo run examples/production_profile.kujo --interpreter (pass); KUJO_BIN=kujo bash scripts/release_quality_gates.sh (pass).
- README updated: Yes
...
- Commands run: kujo test-run tests/sdk_contract_tests.kujo --verbose (pass); KUJO_BIN=kujo bash scripts/release_quality_gates.sh (pass, aggregate tests: 57).
- README updated: Yes
...
- Commands run: kujo test-run tests/sdk_contract_tests.kujo -v (pass).
- README updated: No
...
- Commands run: kujo run scripts/benchmark_quality_gate.kujo --interpreter (pass).
- README updated: No
...
- Commands run: kujo test-run tests/reliability_failure_modes_tests.kujo (pass).
- README updated: No
